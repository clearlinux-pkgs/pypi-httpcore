...
Source0  : https://files.pythonhosted.org/packages/41/16/c809655d32fd93e688b9e2a1aaba1008118369d1eda00818f6f65eb509f8/httpcore-0.17.0.tar.gz
...
%prep
%setup -q -n httpcore-0.17.0
cd %{_builddir}/httpcore-0.17.0
pushd ..
cp -a httpcore-0.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679064893
