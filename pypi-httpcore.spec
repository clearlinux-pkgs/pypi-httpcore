...
Source0  : https://files.pythonhosted.org/packages/9f/45/ad3e1b4d448f22c0cff4f5692f5ed0666658578e358b8d58a19846048059/httpcore-1.0.8.tar.gz
...
%prep
%setup -q -n httpcore-1.0.8
cd %{_builddir}/httpcore-1.0.8
pushd ..
cp -a httpcore-1.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744391760
