...
Source0  : https://files.pythonhosted.org/packages/f9/1a/a2652d94e901308c33b9f17c329b0d327da73b30678a6618d4256a3ac2ae/httpcore-0.16.1.tar.gz
...
%prep
%setup -q -n httpcore-0.16.1
cd %{_builddir}/httpcore-0.16.1
pushd ..
cp -a httpcore-0.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668701178
