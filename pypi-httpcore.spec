...
Source0  : https://files.pythonhosted.org/packages/17/b0/5e8b8674f8d203335a62fdfcfa0d11ebe09e23613c3391033cbba35f7926/httpcore-1.0.5.tar.gz
...
%prep
%setup -q -n httpcore-1.0.5
cd %{_builddir}/httpcore-1.0.5
pushd ..
cp -a httpcore-1.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711640572
