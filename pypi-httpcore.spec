...
Source0  : https://files.pythonhosted.org/packages/2f/3c/b9092a4ba037721d60124f611ea9b0a9020e5e9794bc980db83bc50057cb/httpcore-0.16.0.tar.gz
...
%prep
%setup -q -n httpcore-0.16.0
cd %{_builddir}/httpcore-0.16.0
pushd ..
cp -a httpcore-0.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667843069
