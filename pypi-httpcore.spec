...
Source0  : https://files.pythonhosted.org/packages/b6/44/ed0fa6a17845fb033bd885c03e842f08c1b9406c86a2e60ac1ae1b9206a6/httpcore-1.0.6.tar.gz
...
%prep
%setup -q -n httpcore-1.0.6
cd %{_builddir}/httpcore-1.0.6
pushd ..
cp -a httpcore-1.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727902278
