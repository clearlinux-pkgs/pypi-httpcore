...
Source0  : https://files.pythonhosted.org/packages/06/94/82699a10bca87a5556c9c59b5963f2d039dbd239f25bc2a63907a05a14cb/httpcore-1.0.9.tar.gz
...
%prep
%setup -q -n httpcore-1.0.9
cd %{_builddir}/httpcore-1.0.9
pushd ..
cp -a httpcore-1.0.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745591770
