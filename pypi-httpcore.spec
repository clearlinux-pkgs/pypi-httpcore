...
Source0  : https://files.pythonhosted.org/packages/9b/20/26f6cc4fd00391f8f1c57b0020f5c6eec23904723db04b6f7608e222d815/httpcore-0.16.2.tar.gz
...
%prep
%setup -q -n httpcore-0.16.2
cd %{_builddir}/httpcore-0.16.2
pushd ..
cp -a httpcore-0.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669551537
